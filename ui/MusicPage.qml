    ...
    { 
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Image {
                    source: "images/single_music_ico.svg"
            ...
            TextField  {
                id: urlInput
                Layout.fillWidth: true
                placeholderText: "Cole a URL de uma música do youtube ou spotify"
                ...
                background: Rectangle {
                    ...
                    color: "#1f1e1e"
                    border.width: 2
                    border.color: urlInput.activeFocus ? "#c218d4" : "#444444"
            ...
            Rectangle {
                ...
                MouseArea{
                    ...
                    onClicked:{
                        ...
                        {
                        backend.buscarVideo(urlInput.text)
                        }
                    }
                }    
            }
